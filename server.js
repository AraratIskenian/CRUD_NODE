...
app.post('/addName', (req, res) => {
    ...
    try {
        ...
        // const calTheaters = await mongoose.connection.db.collection('theaters').find({$or : [{'location.address.city': 'California'}, {'location.address.city': 'Bloomington'}]}).toArray(); //
...
const connectionString = 'mongodb+srv://AraratIskenian:Ararat_Tumo0729@cluster0.vcm3hsu.mongodb.net/sample_mflix';